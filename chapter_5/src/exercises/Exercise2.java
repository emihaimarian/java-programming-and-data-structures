 ...
 * random subtraction questions. Revise the program to generate ten random multiplication
 * questions for two integers between 1 and 12. Display the correct count
 * and test time.
 */
...
public class Exercise2 {
    ...
    public static void main(String[] args) {
        ...
        while (countNumberOfQuestions < NUMBER_OF_QUESTIONS) {
            ...
            int number1 = (int) (Math.random() * 12), number2 = (int) (Math.random() * 12);
