 ...
 * directory may contain other folders and files. Use the following command to run the program:
        ...
        if (files != null) {
            for (File file : files) {
                ...
                if (file.isFile() && file.getName().endsWith(".java")) {
                    insertPackage(file, line);
                }
            }
        }
    }

    private static void insertPackage(File file, String line) throws FileNotFoundException {
